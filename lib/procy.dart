...
class procyview extends StatefulWidget {
  const procyview({Key? key}) : super(key: key);

  @override
  State<procyview> createState() => _procyviewState();
}

class _procyviewState extends State<procyview> {
...
<strong>
  ...
  CC米饭开发了该开源的应用程序米饭随身弹幕。该服务由CC米饭提供，旨在安装并使用。
</p> <p>
  我对您使用米饭随身弹幕的隐私政策做出规定，并解释了我如何收集，保护和披露您因使用我的服务而产生的信息。
</p> <p>
  如果您选择使用我提供的服务，则表示您同意收集和使用与此政策相关的信息。我收集的个人信息用于提供和改进服务。除非本隐私政策中另有说明，否则我不会与任何人一起使用或分享您的信息。
</p> <p>
  除非本隐私政策另有规定，否则本隐私政策中使用的术语与我们的条款和条件具有相同的含义，可在米饭随身弹幕中访问。
</p> <p><strong>
  信息收集与使用
</strong></p> <p>
  ...
  如果您对我的隐私政策有任何疑问或建议，请随时通过syywqs@foxmail.com与我联系。
</p> <br>
</body>
           </html>
      """);
